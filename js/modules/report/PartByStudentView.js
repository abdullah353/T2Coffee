...
PartByStudentView = (function(_super) {
  ...
  function PartByStudentView() {
    _ref = PartByStudentView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  PartByStudentView.prototype.initialize = function(options) {
    var aCorrect, correct, dev, devIndex, i, incorrect, index, item, missing, percentile, person, result, total, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref1, _ref2, _ref3, _ref4, _results;
    this.table = [];
    aCorrect = 0;
    this.summary = {
    ...
    for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
      ...
      for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
        ...
        if (item.itemResult === "incorrect") {
          incorrect++;
        }
        if (item.itemResult === "missing") {
          missing++;
        }
        total++;
      }
  ...
  PartByStudentView.prototype.render = function() {
    var detailsHTML, person, summaryHTML, _i, _len, _ref1;
