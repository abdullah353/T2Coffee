...
var PartByStudentMenuView, _ref,
...
PartByStudentMenuView = (function(_super) {
  ...
  function PartByStudentMenuView() {
    _ref = PartByStudentMenuView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  PartByStudentMenuView.prototype.render = function() {
    var flagForCurrent, html, part, subtestId, _i, _len, _ref1;
    if (this.ready) {
      html = "        <select class='part_selector'>          <option disabled='disabled' selected='selected'>Select an assessment</option>          ";
      _ref1 = this.parts;
      for (part = _i = 0, _len = _ref1.length; _i < _len; part = ++_i) {
        subtestId = _ref1[part];
        if (subtestId != null) {
