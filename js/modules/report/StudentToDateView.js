...
StudentToDateView = (function(_super) {
  ...
  function StudentToDateView() {
    ...
    _ref = StudentToDateView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  StudentToDateView.prototype.changeCurrentIndex = function(event) {
    var $target;
    $target = $(event.target);
  ...
  StudentToDateView.prototype.bucketize = function(bucketList) {
  ...
  StudentToDateView.prototype.processResults = function() {
  ...
  StudentToDateView.prototype.readyFlot = function() {
  ...
  StudentToDateView.prototype.getBasicStats = function(result) {
  ...
  StudentToDateView.prototype.render = function() {
    var lineColor;
    this.$el.html("      <h1>" + (t('student progress report')) + "</h1>      <h2>" + (this.options.student.get('name')) + "</h2>      <div id='chart' style='width:450px; height:300px;'></div>      <div id='warnings'></div>    ");
