var KlassToDateView,_ref,__bind=function(a,b){return function(){return a.apply(b,arguments);};},__hasProp={}.hasOwnProperty,__extends=function(d,b){for(var a in b){if(__hasProp.call(b,a)){d[a]=b[a];
}}function c(){this.constructor=d;}c.prototype=b.prototype;d.prototype=new c();d.__super__=b.prototype;return d;};KlassToDateView=(function(b){__extends(a,b);
...
this.subtestsByResultsBucket[m.get("resultBucket")]=[];}this.resultsByBucketByPart[m.get("resultBucket")][q]=l.results.where({subtestId:m.id,klassId:l.klass.id});
...
}}}}return this.warnings=Tangerine.ReportWarnings.KlassToDateView({percentages:this.percentagesByStudent,studentCount:this.options.studentCount});};a.prototype.readyFlot=function(){var d,m,c,n,j,k,e,h,g,f,l=this;
c=this.bucketize(this.bucketList);h=this.subtestsByResultsBucket;for(m in h){e=h[m];if(((g=e[0])!=null?typeof g.get==="function"?g.get("timer"):void 0:void 0)>0&&_.flatten(this.resultsByBucketByPart[e[0].get("resultBucket")]).length>1){c[m]="lines";
...
};a.prototype.render=function(){var c;this.$el.html("      <h1>"+(t("class progress report"))+"</h1>      <p>This class has "+this.options.studentCount+" students.</p>      <div id='chart' style='width:450px; height:300px;'></div>      <div id='warnings'></div>    ");
