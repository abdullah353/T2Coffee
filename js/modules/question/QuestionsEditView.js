...
QuestionsEditView = (function(_super) {
  ...
  function QuestionsEditView() {
    ...
    _ref = QuestionsEditView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  QuestionsEditView.prototype.render = function() {
    var i, question, view, _i, _len, _ref1,
      _this = this;
    this.closeViews();
    ...
    return this.$el.sortable({
      ...
      update: function(event, ui) {
        var id, li, oneQuestion, _j, _len1, _ref2, _results;
        _ref2 = (function() {
