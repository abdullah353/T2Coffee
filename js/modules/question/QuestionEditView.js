...
QuestionEditView = (function(_super) {
  ...
  function QuestionEditView() {
    ...
    _ref = QuestionEditView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  QuestionEditView.prototype.getOptionList = function() {
    var html, i, option, options, _i, _len;
  ...
  QuestionEditView.prototype.render = function() {
    var assessmentName, checkOrRadio, hint, i, linkedGridScore, name, option, optionHTML, options, prompt, skipLogic, skippable, subtestName, type, _i, _len, _ref1,
      _this = this;
    ...
    if (type !== "open") {
      ...
      _ref1 = Tangerine.templates.optionTemplates;
