...
ResultsView = (function(_super) {
  ...
  ResultsView.prototype.tablets = function() {
    var ip, _fn, _i, _len, _ref1,
      _this = this;
    if (this.available.tablets.okCount > 0) {
      _ref1 = this.available.tablets.ips;
      _fn = function(ip) {
  ...
  ResultsView.prototype.render = function() {
    var cloudButton, csvButton, html, result, tabletButton, view, _i, _len, _ref1, _ref2;
    this.clearSubViews();
    ...
    html += "      <h2>Results</h2>    ";
    this.$el.html(html);
    if (((_ref1 = this.results) != null ? _ref1.length : void 0) === 0) {
