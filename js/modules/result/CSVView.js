  ...
  CSVView.prototype.render = function() {
    ...
    if ((this.results != null) && (this.results[0] != null)) {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        for (rawIndex = _k = 0, _ref3 = result.attributes.subtestData.length - 1; 0 <= _ref3 ? _k <= _ref3 : _k >= _ref3; rawIndex = 0 <= _ref3 ? ++_k : --_k) {
          ...
          if (prototype === "id") {
            ...
            for (i = _m = 0, _len2 = _ref5.length; _m < _len2; i = ++_m) {
              item = _ref5[i];
            ...
            for (i = _n = 0, _len3 = _ref7.length; _n < _len3; i = ++_n) {
      ...
      _ref8 = this.results;
      for (d = _o = 0, _len4 = _ref8.length; _o < _len4; d = ++_o) {
        result = _ref8[d];
        row = [];
        _ref9 = this.metaKeys;
        ...
        for (_q = 0, _len6 = _ref10.length; _q < _len6; _q++) {
          subtest = _ref10[_q];
          prototype = subtest.prototype;
          if (prototype === "id") {
            ...
            for (i = _r = 0, _len7 = _ref11.length; _r < _len7; i = ++_r) {
              label = _ref11[i];
            ...
            for (i = _s = 0, _len8 = _ref12.length; _s < _len8; i = ++_s) {
              item = _ref12[i];
            ...
            for (i = _t = 0, _len9 = _ref14.length; _t < _len9; i = ++_t) {
      ...
      for (i = _u = 0, _len10 = csvRowData.length; _u < _len10; i = ++_u) {
        row = csvRowData[i];
        tableHTML += "<tr>";
        count = 0;
        for (index = _v = 0, _ref15 = row.length - 1; 0 <= _ref15 ? _v <= _ref15 : _v >= _ref15; index = 0 <= _ref15 ? ++_v : --_v) {
