...
KlassesView = (function(_super) {
  ...
  function KlassesView() {
    ...
    _ref = KlassesView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  KlassesView.prototype.renderKlasses = function() {
    var $ul, klass, view, _i, _len, _ref1;
    this.closeViews();
    $ul = $("<ul>").addClass("klass_list");
    _ref1 = this.klasses.models;
