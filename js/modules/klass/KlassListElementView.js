...
KlassListElementView = (function(_super) {
  ...
  function KlassListElementView() {
    ...
    _ref = KlassListElementView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  KlassListElementView.prototype.getReportMenu = function(event) {
    var _ref1;
    if ((_ref1 = this.subMenuView) != null) {
      _ref1.close();
    }
  ...
  KlassListElementView.prototype.cancelReport = function() {
    ...
    return (_ref1 = this.subMenuView) != null ? _ref1.close() : void 0;
  };
