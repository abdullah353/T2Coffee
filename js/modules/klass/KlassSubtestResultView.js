...
var KlassSubtestResultView, _ref,
...
KlassSubtestResultView = (function(_super) {
  ...
  function KlassSubtestResultView() {
    _ref = KlassSubtestResultView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  KlassSubtestResultView.prototype.render = function() {
    var correctItems, datum, i, item, percentageCorrect, resultHTML, subtestItems, taken, timestamp, totalItems, _i, _j, _len, _len1, _ref1, _ref2;
    subtestItems = this.options.subtest.get("items");
    resultHTML = "<br>";
    taken = "";
    if (this.options.result.length !== 0) {
      correctItems = totalItems = 0;
      _ref1 = this.options.result[0].get("subtestData").items;
