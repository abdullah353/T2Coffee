...
KlassView = (function(_super) {
  ...
  function KlassView() {
    _ref = KlassView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
      ...
      success: function(assessmentCollection) {
        ...
        return results.fetch({
          success: function(resultCollection) {
            var assessment, _i, _len, _ref1;
            _ref1 = _this.assessments;
  ...
  KlassView.prototype.render = function() {
    var assessment, grade, html, stream, year, _i, _len, _ref1, _ref2;
