...
ObservationPrintView = (function(_super) {
  ...
  function ObservationPrintView() {
    ...
    _ref = ObservationPrintView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  ObservationPrintView.prototype.initializeSurvey = function() {
    ...
    models = (function() {
      ...
      _results = [];
      for (i = _i = 1, _ref1 = parseInt(this.model.get('totalSeconds') / this.model.get('intervalLength')); 1 <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = 1 <= _ref1 ? ++_i : --_i) {
  ...
  ObservationPrintView.prototype.onClose = function() {
    var _ref1;
    if ((_ref1 = this.survey.view) != null) {
      _ref1.close();
    }
  ...
  ObservationPrintView.prototype.getSkipped = function() {
    var i, skippedResults, viewResult, _i, _ref1;
    viewResult = this.skippableView.getSkipped();
    skippedResults = [];
    for (i = _i = 1, _ref1 = this.survey.models.length - 1; 1 <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = 1 <= _ref1 ? ++_i : --_i) {
      skippedResults.push({
        observationNumber: i,
        data: viewResult,
        saveTime: "skipped"
