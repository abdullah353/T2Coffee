...
GridRunView = (function(_super) {
  ...
  function GridRunView() {
    ...
    _ref = GridRunView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  GridRunView.prototype.checkAutostop = function() {
    var autoCount, i, _i, _ref1;
    if (this.timeRunning) {
      autoCount = 0;
      for (i = _i = 0, _ref1 = this.autostop - 1; 0 <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
  ...
  GridRunView.prototype.endOfGridLineClick = function(event) {
    var $target, i, index, value, _i, _j, _ref1, _ref2;
    if (this.mode === "mark") {
      $target = $(event.target);
      if ($target.hasClass("element_wrong")) {
        ...
        value = "correct";
        index = $target.attr('data-index');
        for (i = _i = index, _ref1 = index - (this.columns - 1); index <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = index <= _ref1 ? ++_i : --_i) {
        ...
        value = "incorrect";
        index = $target.attr('data-index');
        for (i = _j = index, _ref2 = index - (this.columns - 1); index <= _ref2 ? _j <= _ref2 : _j >= _ref2; i = index <= _ref2 ? ++_j : --_j) {
          this.markElement(i, value);
        }
      }
      if (this.autostop !== 0) {
  ...
  GridRunView.prototype.resetVariables = function() {
    var i, item, temp, tempValue, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref1, _ref2, _ref3, _ref4, _ref5;
  ...
  GridRunView.prototype.render = function() {
    var captureLastButton, disabling, done, firstRow, gridHTML, html, i, item, minuteItemButton, modeSelector, resetButton, startTimerHTML, stopTimerHTML, _i, _j, _len, _ref1, _ref2;
    done = 0;
    ...
    if (this.layoutMode === "fixed") {
      ...
      while (true) {
        ...
        gridHTML += "<tr>";
        for (i = _i = 1, _ref1 = this.columns; 1 <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = 1 <= _ref1 ? ++_i : --_i) {
          if (done < this.items.length) {
  ...
  GridRunView.prototype.getResult = function() {
    var completeResults, i, item, itemResults, result, _i, _len, _ref1;
    completeResults = [];
    itemResults = [];
    if (!this.captureLastAttempted) {
  ...
  GridRunView.prototype.getSkipped = function() {
    var i, item, itemResults, result, _i, _len, _ref1;
    itemResults = [];
    _ref1 = this.items;
    for (i = _i = 0, _len = _ref1.length; _i < _len; i = ++_i) {
      item = _ref1[i];
