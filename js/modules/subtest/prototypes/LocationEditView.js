...
LocationEditView = (function(_super) {
  ...
  function LocationEditView() {
    _ref = LocationEditView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  LocationEditView.prototype.save = function() {
    var i, level, levels, location, locations, locationsValue, _i, _j, _len, _len1;
    ...
    for (i = _j = 0, _len1 = locations.length; _j < _len1; i = ++_j) {
  ...
  LocationEditView.prototype.isValid = function() {
    var levels, location, _i, _len, _ref1;
    levels = this.model.get("levels");
    _ref1 = this.model.get("locations");
  ...
  LocationEditView.prototype.showErrors = function() {
    var alertText, error, _i, _len, _ref1;
  ...
  LocationEditView.prototype.render = function() {
    var i, levels, location, locations, _i, _len;
    levels = this.model.get("levels") || [];
