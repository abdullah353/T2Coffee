...
var ResultOfQuestion, SurveyRunView, _ref,
...
SurveyRunView = (function(_super) {
  ...
  function SurveyRunView() {
    ...
    _ref = SurveyRunView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  SurveyRunView.prototype.onQuestionAnswer = function(event) {
    var cid, next, view, _i, _len, _ref1, _results;
    if (this.isObservation) {
      cid = $(event.target).attr("data-cid");
      _ref1 = this.questionViews;
      _results = [];
  ...
  SurveyRunView.prototype.showErrors = function() {
    var first, i, message, qv, _i, _len, _ref1, _results;
  ...
  SurveyRunView.prototype.render = function() {
    var i, isNotAsked, notAskedCount, oneView, question, required, _base, _i, _len, _ref1;
    notAskedCount = 0;
    this.questions.sort();
