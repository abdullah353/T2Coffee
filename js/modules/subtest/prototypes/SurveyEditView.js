...
SurveyEditView = (function(_super) {
  ...
  function SurveyEditView() {
    ...
    _ref = SurveyEditView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  SurveyEditView.prototype.save = function() {
    var emptyOptions, i, notSaved, plural, question, requiresGrid, _has, _i, _len, _question, _ref1, _require;
    this.model.set({
    ...
    emptyOptions = [];
    requiresGrid = [];
    _ref1 = this.model.questions.models;
  ...
  SurveyEditView.prototype.onClose = function() {
    var _ref1;
    return (_ref1 = this.questionsListEdit) != null ? _ref1.close() : void 0;
  };

  SurveyEditView.prototype.renderQuestions = function() {
    var _ref1, _ref2;
    this.$el.find("#question_list_wrapper").empty();
    if ((_ref1 = this.questionsEditView) != null) {
      _ref1.render();
    }
