class AssessmentListElementView extends Backbone.View
  ...
  gotoChart: -> Tangerine.router.navigate "chart/#{@model.id}", true
  ...
  render: ->
    ...
    chartButton   = "<img class='link_icon chart' title='Results' src='images/chart.png'>"
    ...
    # enumerator user
      ...
      html = "<div>#{runButton}#{name} #{resultsButton} #{chartButton}</div>"
