...
AssessmentListView = (function(_super) {
  ...
  function AssessmentListView() {
    ...
    _ref = AssessmentListView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  AssessmentListView.prototype.render = function() {
    var assessment, groupList, groupsButton, html, importButton, newButton, oneView, publicList, _i, _j, _len, _len1, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
    this.closeViews();
    this.views = [];
    ...
    this.$el.html(html);
    if (((_ref1 = this.collection) != null ? (_ref2 = _ref1.models) != null ? _ref2.length : void 0 : void 0) > 0) {
  ...
  AssessmentListView.prototype.closeViews = function() {
    var view, _base, _i, _len, _ref1, _results;
