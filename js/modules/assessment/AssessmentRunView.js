...
AssessmentRunView = (function(_super) {
  ...
  function AssessmentRunView() {
    _ref = AssessmentRunView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  AssessmentRunView.prototype.render = function() {
    ...
    if (this.model.subtests.length === 0) {
      ...
      this.$el.html("        <h1>" + (this.model.get('name')) + "</h1>        <div id='progress' style='float:left;width:90%;margin-top:7px;'></div><div id='progressCount' style='float:right;color:#8cc63f;font-weight:bold;'></div><div class='clear' style='clear:both;'></div>      ");
      if (this.index + 1 > 2) {
  ...
  AssessmentRunView.prototype.skip = function() {
    ...
    currentView.close();
    if (this.abortAssessment !== true) {
      this.index++;
    }
    if (this.abortAssessment === true) {
      this.index = this.subtestViews.length - 1;
    }
    this.render();
