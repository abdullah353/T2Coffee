...
AssessmentEditView = (function(_super) {
  ...
  function AssessmentEditView() {
    ...
    _ref = AssessmentEditView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  AssessmentEditView.prototype.updateModel = function() {
    var doublesError, element, groups, i, j, sequence, sequenceErrors, sequences, sequencesValue, tooFewError, tooManyError, _i, _j, _len, _len1;
    sequencesValue = $.trim(this.$el.find("#sequences").val());
    sequences = sequencesValue.split("\n");
    for (i = _i = 0, _len = sequences.length; _i < _len; i = ++_i) {
      sequence = sequences[i];
      sequence = sequence.split(",");
      for (j = _j = 0, _len1 = sequence.length; _j < _len1; j = ++_j) {
        element = sequence[j];
  ...
  AssessmentEditView.prototype.render = function() {
    var arch, archiveChecked, i, key, notArchiveChecked, sequences, subKey, subValue, subtestLegend, subtestTypeSelect, value, _i, _len, _ref1,
      _this = this;
    sequences = "";
    ...
    _ref1 = Tangerine.templates.subtestTemplates;
    for (key in _ref1) {
      value = _ref1[key];
