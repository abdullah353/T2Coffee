...
var AssessmentListElementView, _ref,
...
AssessmentListElementView = (function(_super) {
  ...
  function AssessmentListElementView() {
    _ref = AssessmentListElementView.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  AssessmentListElementView.prototype.gotoChart = function() {
    return Tangerine.router.navigate("chart/" + this.model.id, true);
  };
  ...
  AssessmentListElementView.prototype.render = function() {
    var adminName, archiveClass, archiveSwitch, chartButton, copyButton, deleteButton, deleteConfirm, downloadKey, duplicateButton, editButton, html, name, printButton, resultCount, resultsButton, runButton, selected, toggleButton, updateButton;
    ...
    if (this.isAdmin) {
      ...
      if (Tangerine.settings.context === "mobile") {
        html += "          <div class='assessment_menu'>            " + runButton + "            " + chartButton + "            " + resultsButton + "            " + updateButton + "          </div>        ";
      } else {
        if (this.isPublic) {
